...
# Dynamodb Database Variable
variable "aws_dynamodb_table" {
  type    = string
  default = "globo-tfstatelock"
}

# IAM User Full Access User Variable
...
# IAM User Read Only User Variable
...
# This resourse will pick up rendom nubmer for S3 Bucket, IAM Groups and Dynamodb Tables
